...
import {
  ...
  getModularInstance,
  registerVersion
} from "./chunk-F73TC2WH.js";
import {
  TransferState,
  makeStateKey
} from "./chunk-NJ4CNQUX.js";
import "./chunk-4KWMICZ3.js";
import {
  AsyncPipe
} from "./chunk-WOMX2SGT.js";
import {
  ChangeDetectorRef,
  Inject,
  Injectable,
...
var _AngularFireStorage = class _AngularFireStorage {
...
__publicField(_AngularFireStorage, "ɵfac", function AngularFireStorage_Factory(t) {
...
__publicField(_AngularFireStorage, "ɵprov", ɵɵdefineInjectable({
  token: _AngularFireStorage,
  factory: _AngularFireStorage.ɵfac,
  providedIn: "any"
}));
var AngularFireStorage = _AngularFireStorage;
(() => {
...
var _GetDownloadURLPipe = class _GetDownloadURLPipe {
  constructor(storage, cdr, state) {
    __publicField(this, "storage");
    __publicField(this, "state");
    __publicField(this, "asyncPipe");
  ...
  transform(path) {
    ...
    if (path !== this.path) {
      ...
      const existing = (_a = this.state) == null ? void 0 : _a.get(key, void 0);
      this.downloadUrl$ = existing ? of(existing) : this.storage.ref(path).getDownloadURL().pipe(tap((it) => {
        var _a2;
        return (_a2 = this.state) == null ? void 0 : _a2.set(key, it);
      }));
    }
...
__publicField(_GetDownloadURLPipe, "ɵfac", function GetDownloadURLPipe_Factory(t) {
...
__publicField(_GetDownloadURLPipe, "ɵpipe", ɵɵdefinePipe({
  name: "getDownloadURL",
  type: _GetDownloadURLPipe,
  pure: false
}));
var GetDownloadURLPipe = _GetDownloadURLPipe;
(() => {
...
var _GetDownloadURLPipeModule = class _GetDownloadURLPipeModule {
};
__publicField(_GetDownloadURLPipeModule, "ɵfac", function GetDownloadURLPipeModule_Factory(t) {
  return new (t || _GetDownloadURLPipeModule)();
});
__publicField(_GetDownloadURLPipeModule, "ɵmod", ɵɵdefineNgModule({
  type: _GetDownloadURLPipeModule,
  declarations: [GetDownloadURLPipe],
  exports: [GetDownloadURLPipe]
}));
__publicField(_GetDownloadURLPipeModule, "ɵinj", ɵɵdefineInjector({}));
var GetDownloadURLPipeModule = _GetDownloadURLPipeModule;
(() => {
...
var _AngularFireStorageModule = class _AngularFireStorageModule {
  constructor() {
    firebase.registerVersion("angularfire", VERSION.full, "gcs-compat");
  }
};
__publicField(_AngularFireStorageModule, "ɵfac", function AngularFireStorageModule_Factory(t) {
  return new (t || _AngularFireStorageModule)();
});
__publicField(_AngularFireStorageModule, "ɵmod", ɵɵdefineNgModule({
  type: _AngularFireStorageModule,
  exports: [GetDownloadURLPipeModule]
}));
__publicField(_AngularFireStorageModule, "ɵinj", ɵɵdefineInjector({
  providers: [AngularFireStorage],
  imports: [GetDownloadURLPipeModule]
}));
var AngularFireStorageModule = _AngularFireStorageModule;
(() => {
