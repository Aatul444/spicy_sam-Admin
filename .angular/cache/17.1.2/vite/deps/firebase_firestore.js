...
import {
  ...
  __spreadArray,
  __values
} from "./chunk-DT6KRY74.js";

// node_modules/@firebase/firestore/node_modules/@firebase/util/dist/index.esm.js
...
var Sha1 = (
  ...
  function() {
    ...
    Sha12.prototype.compress_ = function(buf, offset) {
      ...
      for (var i = 16; i < 80; i++) {
        var t2 = W3[i - 3] ^ W3[i - 8] ^ W3[i - 14] ^ W3[i - 16];
        W3[i] = (t2 << 1 | t2 >>> 31) & 4294967295;
      }
      var a = this.chain_[0];
      var b = this.chain_[1];
      var c = this.chain_[2];
      ...
      for (var i = 0; i < 80; i++) {
        ...
        var t2 = (a << 5 | a >>> 27) + f + e + k3 + W3[i] & 4294967295;
        e = d;
        d = c;
...
// node_modules/@firebase/firestore/node_modules/@firebase/logger/dist/index.esm.js
...
function Fn(t2, e) {
  var n = e.currentDocument ? function(t3) {
    return void 0 !== t3.updateTime ? De.updateTime(_n(t3.updateTime)) : void 0 !== t3.exists ? De.exists(t3.exists) : De.none();
  ...
  function(e) {
    ...
    function() {
      ...
      t2.prototype.ki = function(t3, e) {
        if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.10.0", // Content-Type: text/plain will avoid preflight requests which might
        ...
        var e2 = function(t3, e3) {
          return t3 && t3.length > 0 ? (P2(void 0 !== e3), t3.map(function(t4) {
            return function(t5, e4) {
              ...
              (n3 = _n(e4)), new Ne(n3, t5.transformResults || []);
            }(t4, e3);
          })) : [];
          ...
          return e && as(t2).pr ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    return Ge(i2 = e2.code) && i2 !== N2.ABORTED ? (n = t3.Fr.shift(), // In this case it's also unlikely that the server itself is melting
  ...
  (t2.Ur = function(t3, e2, n) {
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return i ? (t2.Ur.sr(), Go(t2) ? Qo(t2) : t2.Br.set(
              "Unknown"
              /* Unknown */
            ), [3, 3]) : [3, 1];
          case 1:
...
function Zu(t2, n) {
  ...
  if (t2 = getModularInstance(t2), Uu("collection", "path", n), t2 instanceof Yu)
    return Qu(r = H2.fromString.apply(H2, __spreadArray([n], i))), new Ju(
      t2,
      /* converter= */
      null,
      r
  ...
  return Qu(r = H2.fromString.apply(H2, __spreadArray([t2.path], i)).child(H2.fromString(n))), new Ju(
    t2.firestore,
    /* converter= */
    null,
    r
...
var lc2 = (
  ...
  function() {
    ...
    return t2.prototype.set = function(t3, e, n) {
      ...
      var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = Ea(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
...
function yc2(t2, e, n) {
  ...
  return mc2(o, [("string" == typeof // For Compat types, we have to "extract" the underlying types before
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype.get = function(t2) {
      ...
      return e.prototype.get.call(this, t2).then(function(t3) {
        return new za2(n2._firestore, i, r._key, t3._document, new Ga2(
          /* hasPendingWrites= */
          false,
          /* fromCache= */
          false
    ...
    function() {
      ...
      return t2.prototype.get = function(t3) {
        ...
        var r = dc2(t3, this._firestore), i = hc2(r.converter, e, n), o = Ea(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
...
var kc2 = (
  ...
  function() {
    ...
    return t2.prototype.fromFirestore = function(t3, e) {
      ...
      return this._delegate.fromFirestore(new Pc2(this._firestore, n), null != e ? e : {});
    ...
    return t2.iu = function(e, n, r) {
      ...
      try {
        return function(t4, e2, n) {
          ...
          return mc2(r, [Ea(Ta(r), "setDoc", t4._key, i, null !== t4.converter, n).toMutation(t4._key, De.none())]);
        }(this._delegate, t3, e);
      } catch (t4) {
      ...
      for (var r = [], i = 2; i < arguments.length; i++)
        r[i - 2] = arguments[i];
      try {
        return 1 === arguments.length ? yc2(this._delegate, t3) : yc2.apply(void 0, __spreadArray([this._delegate, t3, n], r));
      } catch (t4) {
      ...
      return ("cache" === (null == t3 ? void 0 : t3.source) ? function(t4) {
        ...
        return function(t5, e3) {
          ...
          return new za2(e2, o, t4._key, n, new Ga2(
...
var qc2 = (
  ...
  function(e) {
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
      ...
      try {
        return new Cc2(this.firestore, void 0 === t2 ? ta2(this._delegate) : ta2(this._delegate, t2));
      } catch (t3) {
      ...
      return function(t3, e3) {
        ...
        return mc2(n2, [Ea(Ta(t3.firestore), "addDoc", r._key, i, null !== t3.converter, {}).toMutation(r._key, De.exists(false))]).then(function() {
          return r;
        });
...
// node_modules/@firebase/firestore/node_modules/@firebase/component/dist/index.esm.js
var Component = (
  /** @class */
  function() {
...
@firebase/firestore/dist/esm5/prebuilt-306f43d8-45d6f0b9.js:
  (**
   * @license
