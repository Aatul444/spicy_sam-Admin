...
function effect(effectFn, options) {
  ...
  const handle = new EffectHandle(injector.get(APP_EFFECT_SCHEDULER), effectFn, typeof Zone === "undefined" ? null : Zone.current, destroyRef, errorHandler, (_b = options == null ? void 0 : options.allowSignalWrites) != null ? _b : false);
...
var _AfterRenderEventManager = class _AfterRenderEventManager {
  ...
  begin() {
    var _a2;
    (_a2 = this.handler) == null ? void 0 : _a2.validateBegin();
    this.renderDepth++;
  }
  /**
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-VLAB2GDX.js.map
