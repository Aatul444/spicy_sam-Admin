...
var _AngularFireAuth = class _AngularFireAuth {
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
     ...
     * (or null).
     */
    __publicField(this, "idTokenResult");
    /**
     * Observable of the currently signed-in user's credential, or null
     */
    __publicField(this, "credential");
    const logins = new Subject();
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-GYQSYS7G.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
    if (isPlatformServer(platformId)) {
      ...
      this.credential = merge(
        ...
        map((credential) => (credential == null ? void 0 : credential.user) ? credential : null),
...
__publicField(_AngularFireAuth, "ɵfac", function AngularFireAuth_Factory(t) {
...
__publicField(_AngularFireAuth, "ɵprov", ɵɵdefineInjectable({
  token: _AngularFireAuth,
  factory: _AngularFireAuth.ɵfac,
  providedIn: "any"
}));
var AngularFireAuth = _AngularFireAuth;
(() => {
...
var _AngularFireAuthModule = class _AngularFireAuthModule {
  constructor() {
    firebase.registerVersion("angularfire", VERSION.full, "auth-compat");
  }
};
__publicField(_AngularFireAuthModule, "ɵfac", function AngularFireAuthModule_Factory(t) {
  return new (t || _AngularFireAuthModule)();
});
__publicField(_AngularFireAuthModule, "ɵmod", ɵɵdefineNgModule({
  type: _AngularFireAuthModule
}));
__publicField(_AngularFireAuthModule, "ɵinj", ɵɵdefineInjector({
  providers: [AngularFireAuth]
}));
var AngularFireAuthModule = _AngularFireAuthModule;
(() => {
...
//# sourceMappingURL=chunk-T4IE57QD.js.map
