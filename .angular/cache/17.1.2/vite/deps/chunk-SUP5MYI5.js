...
var ɵlazySDKProxy = (klass, observable, zone, options = {}) => {
  return new Proxy(klass, {
    get: (_, name3) => zone.runOutsideAngular(() => {
      var _a;
      if (klass[name3]) {
        if ((_a = options == null ? void 0 : options.spy) == null ? void 0 : _a.get) {
      ...
      const promise = observable.toPromise().then((mod) => {
        const ret = mod == null ? void 0 : mod[name3];
        if (typeof ret === "function") {
          return ret.bind(mod);
        } else if (ret == null ? void 0 : ret.then) {
      ...
      return new Proxy(() => void 0, {
        ...
        apply: (self, _2, args) => promise.then((it) => {
          var _a2;
          const res = it == null ? void 0 : it(...args);
          if ((_a2 = options == null ? void 0 : options.spy) == null ? void 0 : _a2.apply) {
...
var _AngularFireModule = class _AngularFireModule {
...
__publicField(_AngularFireModule, "ɵfac", function AngularFireModule_Factory(t) {
  return new (t || _AngularFireModule)(ɵɵinject(PLATFORM_ID));
});
__publicField(_AngularFireModule, "ɵmod", ɵɵdefineNgModule({
  type: _AngularFireModule
}));
__publicField(_AngularFireModule, "ɵinj", ɵɵdefineInjector({
  providers: [FIREBASE_APP_PROVIDER]
}));
var AngularFireModule = _AngularFireModule;
(() => {
...
firebase/compat/app/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SUP5MYI5.js.map
