import {
  ...
  USE_EMULATOR,
  ɵauthFactory
} from "./chunk-T4IE57QD.js";
import "./chunk-6MKP3EGH.js";
...
function fromDocRef(ref, scheduler) {
  return fromRef(ref, scheduler).pipe(startWith(void 0), pairwise(), map((snapshots) => {
    ...
    if (!(priorPayload == null ? void 0 : priorPayload.exists)) {
      return {
        payload,
        type: "added"
      };
  ...
  return fromCollectionRef(query2, scheduler).pipe(startWith(void 0), pairwise(), map((actionTuple) => {
    ...
    if (priorAction && JSON.stringify(priorAction.payload.metadata) !== JSON.stringify(action.payload.metadata)) {
      action.payload.docs.forEach((currentDoc, currentIndex) => {
        ...
        const priorDoc = priorAction == null ? void 0 : priorAction.payload.docs.find((d) => d.ref.isEqual(currentDoc.ref));
...
var _AngularFirestore = class _AngularFirestore {
  /**
  ...
  constructor(options, name2, shouldEnablePersistence, settings, platformId, zone, schedulers, persistenceSettings, _useEmulator, auth, useAuthEmulator, authSettings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    __publicField(this, "schedulers");
    __publicField(this, "firestore");
    __publicField(this, "persistenceEnabled$");
...
__publicField(_AngularFirestore, "ɵfac", function AngularFirestore_Factory(t) {
...
__publicField(_AngularFirestore, "ɵprov", ɵɵdefineInjectable({
  token: _AngularFirestore,
  factory: _AngularFirestore.ɵfac,
  providedIn: "any"
}));
var AngularFirestore = _AngularFirestore;
(() => {
...
var _AngularFirestoreModule = class _AngularFirestoreModule {
  constructor() {
...
__publicField(_AngularFirestoreModule, "ɵfac", function AngularFirestoreModule_Factory(t) {
  return new (t || _AngularFirestoreModule)();
});
__publicField(_AngularFirestoreModule, "ɵmod", ɵɵdefineNgModule({
  type: _AngularFirestoreModule
}));
__publicField(_AngularFirestoreModule, "ɵinj", ɵɵdefineInjector({
  providers: [AngularFirestore]
}));
var AngularFirestoreModule = _AngularFirestoreModule;
(() => {
