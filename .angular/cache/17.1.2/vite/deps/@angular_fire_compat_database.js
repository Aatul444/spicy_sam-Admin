...
function buildView(current, action) {
  ...
  switch (action.type) {
    case "value":
      if ((_a = action.payload) == null ? void 0 : _a.exists()) {
        let prevKey2 = null;
    ...
    case "child_added":
      if (currentKeyPosition > -1) {
        ...
        if (((previous == null ? void 0 : previous.key) || null) !== prevKey) {
...
var _AngularFireDatabase = class _AngularFireDatabase {
...
__publicField(_AngularFireDatabase, "ɵfac", function AngularFireDatabase_Factory(t) {
...
__publicField(_AngularFireDatabase, "ɵprov", ɵɵdefineInjectable({
  token: _AngularFireDatabase,
  factory: _AngularFireDatabase.ɵfac,
  providedIn: "any"
}));
var AngularFireDatabase = _AngularFireDatabase;
(() => {
...
var _AngularFireDatabaseModule = class _AngularFireDatabaseModule {
  constructor() {
    firebase.registerVersion("angularfire", VERSION.full, "rtdb-compat");
  }
};
__publicField(_AngularFireDatabaseModule, "ɵfac", function AngularFireDatabaseModule_Factory(t) {
  return new (t || _AngularFireDatabaseModule)();
});
__publicField(_AngularFireDatabaseModule, "ɵmod", ɵɵdefineNgModule({
  type: _AngularFireDatabaseModule
}));
__publicField(_AngularFireDatabaseModule, "ɵinj", ɵɵdefineInjector({
  providers: [AngularFireDatabase]
}));
var AngularFireDatabaseModule = _AngularFireDatabaseModule;
(() => {
